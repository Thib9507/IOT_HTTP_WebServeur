...
struct net_if_drv_s
{
  ...
  /* Service */
  int32_t (* pgethostbyname)(net_if_handle_t *pnetif, net_sockaddr_t *addr, char_t *name);
  int32_t (* pping)(net_if_handle_t *pnetif, net_sockaddr_t *addr, int32_t count, int32_t delay, int32_t response[]);
